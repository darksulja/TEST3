...
DELIVERY_TEST_SCRIPT=/opt/evertz/mediator/etc/runners/run_AsperaFaspexDelivery.js
JS_DIR=/opt/evertz/mediator/lib/js/

echo -e "$RHINO_CLASSPATH"
echo -e "\nIn deliveryAsperaFaspexClassPathLoader.sh Running ${DELIVERY_TEST_SCRIPT} \nArguments  are ${@}"
