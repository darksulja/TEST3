...
${BASE_PATH}spring-aop-4.2.3.RELEASE.jar:\
${BASE_PATH}javax.inject-1.jar:\
${BASE_PATH}spring-beans-4.2.3.RELEASE.jar:\
${BASE_PATH}spring-context-4.2.3.RELEASE.jar:\
${BASE_PATH}spring-core-4.2.3.RELEASE.jar:\
...
${BASE_PATH}slf4j-api-1.7.12.jar:\
...
${BASE_PATH}spring-expression-4.2.3.RELEASE.jar:\
...
EMAIL_SCRIPT=/opt/evertz/mediator/etc/runners/run_sendCustomEmail.js
JS_DIR=/opt/evertz/mediator/lib/js/

echo -e "\nIn customEmailClassPathLoader.sh Running ${EMAIL_SCRIPT} \nArguments  are ${@}"

java -Dfile.encoding=utf-8 -cp "$RHINO_CLASSPATH" "$SHELL" "/opt/evertz/mediator/lib/js/wsshell.js" "$@" "$EMAIL_SCRIPT" "$JS_DIR"
