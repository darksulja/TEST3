...
(function() {
        ...
        var getHostName = function() {
                var hostname = run("/bin/hostname").output.replace(/(\r\n|\n|\r)/gm,"");
                return hostname;
        }
        ...
        var isValidMediaForExport = function(mediaValues,mediaName) {
                ...
                if (!fileExists(mediaValues.mount)) {
                        if (getHostName().toLowerCase().indexOf("-ec-") >= 0 && mediaName.toLowerCase().indexOf("dc_") === 0) {
                                print("Allowing EC node access to DC Media");
                        } else {
    ...
    // Define the Look Up
        var allSystemVars = [
                // Drop Folders for Uploads
                {
                    ...
                    systemname : "DC-GMO-PROD",
                    values : {
                        mount : "/srv/dc-delivery-01/DIGITAL_DELIVERY/INCOMING_TO_DENVER/Aspera_Incoming/FROM_DREAMWORKS/CLASSIC_MEDIA_01/",
                        stagingMedia : "DC_DELIVERY1_STAGING"
                    }
                },{
                    type : "dropfolder",
                    ...
                    systemname : "DC-GMO-DEV",
                    values : {
                        mount : "/srv/dc-delivery-02/DIGITAL_DELIVERY/INCOMING_TO_DENVER/MEDIATOR_UPLOAD/UTS_INGEST/",
                        stagingMedia : "DC_DELIVERY2_STAGING"
                    }
                },{
                    type : "dropfolder",
                    ...
                    type : "dropfolder",
                    ref : "FROM_StudioPost_T2_Components_UTC",
                    systemname : "DC-GMO-DEV",
                    values : {
                        mount : "/srv/dc-isilon-full/GMO/Mediator/dev-mediator/Delivery/FROM_StudioPost_T2_Components_UTC/",
                        stagingMedia : "DC_T2_OM_STAGING"
                    }
                },{
                    type : "dropfolder",
                    ...
                    systemname : "DC-GMO-QA",
                    values : {
                        mount : "/srv/dc-isilon-full/GMO/Mediator/qa-mediator/Delivery/FROM_StudioPost_T2_Components_UTC/",
                        stagingMedia : "DC_T2_OM_STAGING"
                    }
                },{
                    type : "dropfolder",
                    ...
                    systemname : "DC-GMO-PROD",
                    values : {
                        mount : "/srv/dc-isilon-full/GMO/Mediator/prod-mediator/Delivery/FROM_StudioPost_T2_Components_UTC/",
                        stagingMedia : "DC_T2_OM_STAGING"
                    }
                },{
                    type : "dropfolder",
                    ...
                    systemname : "DC-GMO-DEV",
                    values : {
                        mount : "/srv/dc-delivery-02/DIGITAL_DELIVERY/dev-mediator/INCOMING_TO_DENVER/Aspera_Incoming/FROM_TELEMUNDO_MIGRATION/MEDIATOR_UPLOAD/",
                        stagingMedia : "DC_DELIVERY2_STAGING"
                    }
                },{
                    type : "dropfolder",
                    ...
                    systemname : "DC-GMO-QA",
                    values : {
                        mount : "/srv/dc-delivery-02/DIGITAL_DELIVERY/qa-mediator/INCOMING_TO_DENVER/Aspera_Incoming/FROM_TELEMUNDO_MIGRATION/MEDIATOR_UPLOAD/",
                        stagingMedia : "DC_DELIVERY2_STAGING"
                    }
                },{
                    type : "dropfolder",
                    ...
                    systemname : "DC-GMO-PROD",
                    values : {
                        mount : "/srv/dc-delivery-02/DIGITAL_DELIVERY/INCOMING_TO_DENVER/Aspera_Incoming/FROM_TELEMUNDO_MIGRATION/MEDIATOR_UPLOAD/",
                        stagingMedia : "DC_DELIVERY2_STAGING"
                    }
                },{
					type : "dropfolder",
