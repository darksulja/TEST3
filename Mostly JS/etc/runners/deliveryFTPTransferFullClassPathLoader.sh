...
DELIVERY_TEST_SCRIPT=/opt/evertz/mediator/etc/runners/run_ftpTransferModule.js
JS_DIR=/opt/evertz/mediator/lib/js/

echo -e "$RHINO_CLASSPATH"
echo -e "\nIn deliveryFTPTransferFullClassPathLoader.sh Running ${DELIVERY_TEST_SCRIPT} \nArguments  are ${@}"
