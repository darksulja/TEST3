...
var NBCAsperaFaspex =  function() {
	...
	this.printParameters = function(){
		...
		print("\nFaspex Source Paths - "+this._paths);
	}
	...
	this.removeXMLHeader = function(input_xml) {
	...
	this.getJobStatus = function(link){
		...
		if(status==200) {
			var responseXML = new XML(this.removeXMLHeader(response));
			print("\n"+responseXML);
